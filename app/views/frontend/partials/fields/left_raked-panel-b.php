...
<div class="raked-panel-container">
	...
	<div class="fencing-left-panel-o-b">
		...
		class="fencing-panel-item fencing-raked-panel fencing-left-panel-b fencing-btn-modal panel-item ally" 
		data-id="{{panel_number}}" 
		data-cart-key="left_raked_panel" 
		data-cart-value="{{panel_size}}x{{panel_height}}" 
		data-key="left_side" 
		data-target="#fc-control-modal">

			<div class="fencing-panel-item-size"><span class="fc-panel-unit">RAKED</span>{{panel_size}}H <span class="fc-raked-width"><br> {{panel_unit}}W</span></div>
