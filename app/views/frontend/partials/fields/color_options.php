            ...
            <div class="fc-color-options-slick-area">
                <div class="fc-form-field fc-color-options js-fc-color-options-slick" data-key="color_options" data-slug="{{slug}}" name="color_options" type="text_option" value="">
                    ...
                    <div class="fc-color-options__slide">
                        <div class="fc-select-item fc-select fc-select-color fc-mb-0" data-color-title="<?php echo e((string) $co_v['title']); ?>" data-color-code="<?php echo e((string) $co_v['background_color']); ?>" data-color-subtitle="<?php echo e((string) $co_v['sub_title']); ?>" data-slug="<?php echo e((string) $co_k); ?>" style="background:<?php echo e((string) $co_v['background_color']); ?>;color:<?php echo e((string) $co_v['text_color']); ?>;">
                            <p><strong><?php echo e((string) $co_v['title']); ?></strong><br />
