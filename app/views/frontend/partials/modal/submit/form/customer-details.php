    ...
    <div class="row">
        ...
        <div class="col-12 col-md mb-3">
            <div class="fc-label-group has-clear position-relative">
                ...
                <input type="tel" name="mobile" id="mobile" phone-format="9999 999 999" class="form-control p-3 no-space numeric-only input-mobile" placeholder="0412 345 678" inputmode="numeric" autocomplete="tel-national" data-msg-required="Please enter your mobile number." required>       
