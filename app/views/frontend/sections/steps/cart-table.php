<?php
require_once dirname(__DIR__, 5) . '/app/src/Services/FenceCatalogService.php';
require_once dirname(__DIR__, 5) . '/app/src/Services/WcProductCsvService.php';
                ...
                <tr class="fc-position-relative">
                    ...
                    <td class="align-top" style="width: max-content;">
                        ...
                        if ( ! class_exists( '\Fc\Admin\Services\ConsoleSettings' ) ) {
                            require_once dirname( __DIR__, 5) . '/app/src/Services/ConsoleSettings.php';
                        }
