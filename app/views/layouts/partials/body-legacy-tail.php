    ...
    <div id="fc-admin-shell" class="flex h-full w-full">
        ...
        >
            <div class="fc-sidebar-brand">
                <?php $fcSidebarLogoUrl = \Fc\Admin\Services\BrandingSettings::logoUrl($fcAppBase, $fcBranding); ?>
                <span class="fc-sidebar-brand__mark<?php echo $fcSidebarLogoUrl !== '' ? ' fc-sidebar-brand__mark--image' : ''; ?>" aria-hidden="true">
                    <?php echo \Fc\Admin\Services\BrandingSettings::logoMarkup($fcAppBase, $fcBranding, ['img_class' => 'fc-sidebar-brand__logo-img']); ?>
                </span>
            ...
            <div class="fc-sidebar-footer">
                ...
                <div class="fc-sidebar-user" data-fc-sidebar-user-menu>
                    ...
                    >
                        ...
                        <a
                            href="<?php echo htmlspecialchars(\Fc\Admin\Models\AuthPresenter::logoutUrl($fcAdminBase), ENT_QUOTES, 'UTF-8'); ?>"
