 ...
 *
 * Read-only template: PlannerEntryPresenter::detailViewData() guarantees the
 * 'item' key (null when the entry is missing — the body branches on that).
 * Escaping via the global e()/cell() helpers; the layout gates rendering.
 *
        ...
        <div class="fc-entries-detail-page__grid">
                ...
                <div class="fc-entries-modal__meta fc-entries-modal__meta--detail">
                    ...
                    <div class="fc-entries-modal__row fc-entries-detail-copy-row">
                        ...
                        <div class="fc-entries-modal__value-wrap">
                            ...
                            <span class="<?php echo e((string) ($detailRow['status_class'] ?? '')); ?>"><?php echo cell($detailRow['display'] ?? ''); ?></span>
                            <?php elseif (($detailRow['key'] ?? '') === 'device' && ($detailRow['display'] ?? '') !== '—') : ?>
                            <span class="fc-entries-device">
                                <i class="<?php echo e((string) ($detailRow['device_icon'] ?? 'fa-solid fa-circle-question')); ?>" aria-hidden="true"></i>
            ...
            <section class="fc-entries-detail-panel fc-entries-detail-panel--cart">
                ...
                <div class="fc-entries-cart-table-wrap">
                    <table class="fc-entries-cart-table">
                        ...
                        <tbody>
                            ...
                            <tr
                                class="fc-entries-cart-table__row<?php echo e((string) ($cartRow['row_class'] ?? '')); ?>"
                                data-fc-cart-row
                                data-fc-cart-search="<?php echo e((string) ($cartRow['search_haystack'] ?? '')); ?>"
                                data-fc-cart-fence="<?php echo e((string) ($cartRow['fence_slug'] ?? '')); ?>"
                            ...
                            >
                                <td class="fc-entries-cart-table__image">
                                    ...
                                    <button
                                        ...
                                        data-fc-cart-gallery-url="<?php echo e((string) ($cartRow['image_url'] ?? '')); ?>"
                                        data-fc-cart-gallery-caption="<?php echo e((string) ($cartRow['gallery_caption'] ?? '')); ?>"
                                        aria-label="View image: <?php echo e((string) ($cartRow['gallery_caption'] ?? '')); ?>"
                                    >
                                        <img alt="" class="fc-entries-cart-table__thumb fc-lazy" data-fc-lazy data-fc-lazy-src="<?php echo e((string) ($cartRow['image_url'] ?? '')); ?>" decoding="async">
                ...
                <footer class="fc-entries-detail-panel__foot">
                    <span data-fc-cart-footer-lines><?php echo e((string) ($page['cart_lines_label'] ?? '')); ?></span>
                    <span class="fc-entries-detail-panel__foot-total" data-fc-cart-footer-units><?php echo e((string) ($page['cart_units_label'] ?? '')); ?></span>
                </footer>
            </section>
        </div>
    </div>
