...
if (!isset($fcEntriesPage) || !is_array($fcEntriesPage)) {
    return;
}

$h = static fn(string $v): string => \Fc\Admin\Helpers\StringHelper::escapeHtml($v);
$cell = static fn(mixed $v): string => \Fc\Admin\Helpers\ViewHelper::cell($v);
$page = $fcEntriesPage;
...
<div
    ...
    data-fc-entries-api="<?php echo $h((string) ($page['api_url'] ?? 'api.php?module=entries')); ?>"
    data-fc-entries-view="<?php echo $h((string) ($page['view'] ?? 'all')); ?>"
    data-fc-entries-csrf="<?php echo $h((string) ($page['csrf'] ?? '')); ?>"
>
            ...
            <div class="fc-entries-page__toolbar-row">
                ...
                <div class="fc-entries-advanced-search" id="fc-entries-advanced-search" data-fc-entries-advanced-modal hidden>
                            ...
                            <div class="fc-entries-advanced-search__grid">
                                <label class="fc-entries-advanced-search__field">
                                    ...
                                    <select class="fc-entries-page__filter" name="status">
                                        ...
                                        <option value="<?php echo $h((string) $status); ?>"<?php echo ($req['status'] ?? '') === $status ? ' selected' : ''; ?>>
                                            <?php echo $h((string) $status); ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </label>
                                <label class="fc-entries-advanced-search__field">
                                    ...
                                    <select class="fc-entries-page__filter" name="timeframe">
                                        ...
                                        <option value="<?php echo $h((string) $timeframeKey); ?>"<?php echo ($req['timeframe'] ?? '') === $timeframeKey ? ' selected' : ''; ?>>
                                            <?php echo $h((string) $timeframeLabel); ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </label>
                                <label class="fc-entries-advanced-search__field">
                                    ...
                                    <select class="fc-entries-page__filter" name="state">
                                        ...
                                        <option value="<?php echo $h((string) $stateKey); ?>"<?php echo ($req['state'] ?? '') === $stateKey ? ' selected' : ''; ?>>
                                            <?php echo $h((string) $stateKey); ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </label>
                                <label class="fc-entries-advanced-search__field">
                                    ...
                                    <input
                                        ...
                                        name="postcode"
                                        value="<?php echo $h((string) ($req['postcode'] ?? '')); ?>"
                                        maxlength="32"
                                        inputmode="numeric"
                                            ...
                                            continue;
                                                ...
                                                <label class="fc-entries-fence-dropdown__option" role="option" aria-selected="<?php echo in_array($browserKey, (array) ($req['browser'] ?? []), true) ? 'true' : 'false'; ?>">
                                                    <input
                                                        type="checkbox"
                                                        name="browser[]"
                                                        value="<?php echo $h((string) $browserKey); ?>"
                                                        data-fc-entries-multi-checkbox
                                                        <?php echo in_array($browserKey, (array) ($req['browser'] ?? []), true) ? 'checked' : ''; ?>
                                                    >
                                                    <span><?php echo $h((string) $browserLabel); ?></span>
                                                </label>
                                        <?php endforeach; ?>
                                            </div>
                                            <div class="fc-entries-fence-dropdown__footer">
                    ...
                    >
                        ...
                        <option value="<?php echo $h((string) $fieldKey); ?>"<?php echo ($page['date_field'] ?? 'updated_at') === $fieldKey ? ' selected' : ''; ?>>
                            <?php echo $h((string) $fieldLabel); ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                    ...
                    >
                        <input type="hidden" name="date_period" value="<?php echo $h((string) ($page['date_period'] ?? '')); ?>" data-fc-entries-date-period>
                        <input type="hidden" name="date_from" value="<?php echo $h((string) ($page['date_from'] ?? '')); ?>" data-fc-entries-date-from>
                        <input type="hidden" name="date_to" value="<?php echo $h((string) ($page['date_to'] ?? '')); ?>" data-fc-entries-date-to>
                        <button
                            type="button"
                        ...
                        >
                            ...
                            <span class="fc-entries-date-dropdown__label" data-fc-entries-date-label><?php echo $h((string) ($page['date_filter_label'] ?? '')); ?></span>
                        ...
                        >
                            ...
                            <div class="fc-entries-date-dropdown__custom-wrap">
                                ...
                                >
                                    <span><?php echo $h((string) ($page['date_period_options']['custom'] ?? 'Custom')); ?></span>
                                    <i class="fa-solid fa-check fc-entries-date-dropdown__check" aria-hidden="true"></i>
                                </button>
                                <div
                            ...
                            <div class="fc-entries-date-dropdown__footer">
                                ...
                                <div class="fc-entries-advanced-search__field fc-entries-advanced-search__field--wide fc-entries-advanced-search__field--fence">
                                    ...
                                    >
                                        ...
                                        >
                                            <span class="fc-entries-fence-dropdown__label" data-fc-entries-multi-label><?php echo $h((string) ($page['fence_type_filter_label'] ?? '')); ?></span>
                                            <i class="fa-solid fa-chevron-down fc-entries-fence-dropdown__caret" aria-hidden="true"></i>
                                        </button>
                                        <div
                                            class="fc-entries-fence-dropdown__panel"
                        ...
                        <footer class="fc-entries-advanced-search__footer">
                            <div>
                                <?php if (!empty($page['has_active_filters'])) : ?>
                                <a class="btn btn-sm btn-light fw-semibold" href="<?php echo $h((string) ($page['clear_filters_url'] ?? '')); ?>">Clear all filters</a>
                                <?php endif; ?>
                            </div>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="fc-entries-table__check-col">
                            <label class="fc-entries-check">
                                <input
                                    ...
                                    aria-label="<?php echo $h('Select entry ' . ($row['planner_id'] ?? '')); ?>"
                                >
                            </label>
                        </td>
                        <?php endif; ?>
                        ...
                        <td class="fc-entries-table__truncate">
                            <?php if ($rowCanOpen) : ?>
                            <a class="fc-entries-row-link" href="<?php echo $h($rowHref); ?>">
                                <span class="<?php echo $h((string) ($row['status_class'] ?? '')); ?>">
                        ...
                        <td class="fc-entries-table__truncate"><?php if ($rowCanOpen) : ?><a class="fc-entries-row-link" href="<?php echo $h($rowHref); ?>"><?php echo $cell($row['date_at'] ?? ''); ?></a><?php else : ?><span class="fc-entries-row-text"><?php echo $cell($row['date_at'] ?? ''); ?></span><?php endif; ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
        ...
        <div class="fc-entries-page__footer-row">
            <div class="fc-entries-page__bulk" data-fc-entries-bulk<?php echo empty($page['bulk_action_options']) ? ' hidden' : ''; ?>>
                ...
                <select id="fc-entries-bulk-action" class="fc-entries-page__bulk-select" data-fc-entries-bulk-action disabled>
                    ...
                    <option value="<?php echo $h((string) ($bulkOption['value'] ?? '')); ?>">
                        <?php echo $h((string) ($bulkOption['label'] ?? '')); ?>
                    </option>
                    <?php endforeach; ?>
                </select>
