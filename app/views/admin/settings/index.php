        ...
        <div class="flex h-full min-h-0 flex-col">
            <div class="fc-admin-sticky-header sticky top-0 z-20 flex shrink-0 flex-wrap items-center justify-between gap-4 border-b border-slate-200 bg-white px-4 py-4 sm:px-6">
                ...
                <div id="fc-settings-header-actions-theme" class="<?php echo e((string) $tab['header_actions_class']['theme']); ?> flex-wrap gap-2">
                    ...
                    <button type="button" id="fc-theme-save" class="<?php echo e((string) $tab['btn_primary']); ?>">Save Changes</button>
                </div>
                <div id="fc-settings-header-actions-branding" class="<?php echo e((string) $tab['header_actions_class']['branding']); ?> flex-wrap gap-2">
                    ...
                    <button type="button" id="fc-branding-save" class="<?php echo e((string) $tab['btn_primary']); ?>">Save Changes</button>
                </div>
                <div id="fc-settings-header-actions-fence-colors" class="<?php echo e((string) $tab['header_actions_class']['fence_colors']); ?> flex-wrap gap-2">
                    ...
                    <button type="button" id="fc-fence-colors-save" class="<?php echo e((string) $tab['btn_primary']); ?>">Save Changes</button>
                </div>
                <div id="fc-settings-header-actions-catalog" class="<?php echo e((string) $tab['header_actions_class']['catalog']); ?> flex-wrap gap-2">
                    ...
                    <button type="button" id="fc-catalog-save" class="<?php echo e((string) $tab['btn_primary']); ?>">Save Changes</button>
                </div>
                <div id="fc-settings-header-actions-system" class="<?php echo e((string) $tab['header_actions_class']['system']); ?> flex-wrap gap-2">
                    ...
                    <button type="button" id="fc-system-save" class="<?php echo e((string) $tab['btn_primary']); ?>">Save Changes</button>
                </div>
                <div id="fc-settings-header-actions-integration" class="<?php echo e((string) $tab['header_actions_class']['integration']); ?> flex-wrap gap-2">
                    ...
                    <button type="button" id="fc-integration-save" class="<?php echo e((string) $tab['btn_primary']); ?>">Save Changes</button>
                </div>
                <div id="fc-settings-header-actions-project-plan" class="<?php echo e((string) $tab['header_actions_class']['project_plan']); ?> flex-wrap gap-2">
                    ...
                    <button type="button" id="fc-project-plan-save" class="<?php echo e((string) $tab['btn_primary']); ?>">Save Changes</button>
                </div>
            ...
            <div class="min-h-0 flex-1 overflow-y-auto overflow-x-hidden">
                <div id="fc-settings-layout" class="grid w-full grid-cols-1 gap-6 p-4 sm:p-6 lg:items-start <?php echo e((string) $tab['layout_class']); ?>">
                    <div class="min-w-0 space-y-5">
                        <div id="fc-settings-panel-theme" class="<?php echo e((string) $tab['panel_class']['theme']); ?>space-y-5 mt-[1.25rem]">
                            ...
                            <section class="flex h-full flex-col border border-slate-200 bg-slate-50/60 p-3 sm:p-4">
                                <h3 class="mb-2 text-sm font-semibold uppercase tracking-wide text-slate-500"><?php echo e((string) $group['label']); ?></h3>
                            ...
                            <section class="flex h-full flex-col border border-slate-200 bg-slate-50/60 p-4 sm:p-5 space-y-3">
                                ...
                                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                    <label class="flex min-w-0 flex-col gap-1" for="fc-integration-webhookUrl">
                                        ...
                                        <span class="fc-settings-field-input-wrap">
                                            <input type="text" id="fc-integration-webhookUrl" data-fc-integration-field="webhookUrl" value="<?php echo e((string) ($integrations['webhookUrl'] ?? '')); ?>" class="fc-settings-field font-mono text-xs" placeholder="https://hooks.zapier.com/hooks/catch/…" autocomplete="off" spellcheck="false" />
                                    ...
                                    <label class="flex min-w-0 flex-col gap-1" for="fc-integration-webhookTestUrl">
                                        ...
                                        <span class="fc-settings-field-input-wrap">
                                            <input type="text" id="fc-integration-webhookTestUrl" data-fc-integration-field="webhookTestUrl" value="<?php echo e((string) ($integrations['webhookTestUrl'] ?? '')); ?>" class="fc-settings-field font-mono text-xs" placeholder="https://webhook.site/…" autocomplete="off" spellcheck="false" />
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-3">
                                    ...
                                    <div class="inline-flex rounded-lg border border-slate-200 bg-white p-0.5 text-xs font-semibold">
                                        ...
                                        <label class="relative cursor-pointer" title="<?php echo e((string) $label); ?>">
                                            <input
                                                type="radio"
                                            ...
                                            >
                                            <span class="fc-mode-pill block rounded-md px-3 py-1 text-slate-600 transition-colors peer-checked:text-white"><?php echo e(ucfirst((string) $value)); ?></span>
                                        </label>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    ...
                                    <div class="flex flex-wrap rounded-lg bg-slate-200/80 p-1" role="group" aria-label="Debug Mode">
                                        <button
                                            ...
                                            class="rounded-md px-4 py-2 text-sm font-medium transition <?php echo e($debugOffClass); ?>"
                                        >Off</button>
                                        <button
                                            type="button"
                                            data-fc-debug-mode="1"
                                            aria-pressed="<?php echo $debugModeOn ? 'true' : 'false'; ?>"
                                            class="rounded-md px-4 py-2 text-sm font-medium transition <?php echo e($debugOnClass); ?>"
                                        >On</button>
                                    </div>
                                </div>
                            </section>
                    ...
                    <div class="<?php echo e((string) $tab['preview_hidden']); ?>sticky top-4 z-10 self-start" id="fc-settings-preview">
