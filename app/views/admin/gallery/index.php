 ...
 *
 * Read-only template: GalleryPresenter::viewData() guarantees every shape here.
...
?>
<div
    class="<?php echo e((string) $page['page_class']); ?>"
    data-fc-gallery-page
    data-fc-gallery-server="1"
    data-fc-gallery-initial-tab="<?php echo e((string) $page['initial_tab']); ?>"
>
    ...
    <div class="fc-gallery-page__toolbar" data-fc-admin-sticky-header>
        <div class="fc-gallery-page__toolbar-row">
            ...
            <span class="fc-gallery-page__count"><?php echo e((string) ($page['count_label'] ?? '')); ?></span>
        </div>
    </div>
    ...
    <div class="fc-gallery-page__content" data-fc-lazy-root>
        ...
        <div class="fc-gallery-error">
            ...
            <p class="fc-gallery-error__message"><?php echo e((string) $page['error']); ?></p>
        </div>
        ...
        <ul class="fc-gallery-grid" data-fc-gallery-grid>
            ...
            <li class="fc-gallery-grid__item">
                <div class="fc-gallery-item-wrap" data-fc-gallery-wrap="<?php echo e((string) ($row['path'] ?? '')); ?>">
                    <?php if (!empty($page['can_delete'])) : ?>
                    <label class="fc-gallery-item__check" data-fc-gallery-check-wrap="<?php echo e((string) ($row['path'] ?? '')); ?>">
                        <input
                            type="checkbox"
                            class="fc-gallery-item__check-input"
                            data-fc-gallery-select="<?php echo e((string) ($row['path'] ?? '')); ?>"
                    ...
                    <button
                        ...
                        data-fc-gallery-item="<?php echo e((string) ($row['path'] ?? '')); ?>"
                        title="<?php echo e((string) ($row['name'] ?? '')); ?>"
                    >
                        <span class="fc-gallery-item__thumb">
                            <span class="fc-gallery-item__badge"><?php echo e((string) ($row['type_badge'] ?? '')); ?></span>
                            <img
                                alt=""
                                class="fc-lazy"
                                data-fc-lazy
                                data-fc-lazy-src="<?php echo e((string) ($row['asset_url'] ?? '')); ?>"
                                decoding="async"
                            >
                        </span>
                    </button>
    ...
    <div class="fc-gallery-page__upload-panel">
        ...
        >
            ...
            <input
                ...
                accept="<?php echo e((string) ($page['accept_types'] ?? '')); ?>"
                multiple
                hidden
            >
        </div>
