...
(function (global) {
    ...
    function renderDropzone(full, compact) {
        ...
        return (
            ...
            '</p>' +
            (full && !compact
                ? '<p class="fc-media-picker__dropzone-hint">JPG, PNG, GIF, WebP, or SVG · saved to <code>assets/uploads</code></p>'
                : '') +
    ...
    function ensureUploadQueue() {
        if (pickerState.uploadQueue || !global.FcGalleryUploadQueue) {
