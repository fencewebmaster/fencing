	...
	'settings' => [
		...
		'left_side'	=> [
			...
			'fields' => [
				[
					...
					'options' => [
						[						
							...
							'type' => 'range_option',
							'key' => 'left_side',
							'image' => 'assets/img/clamps/gap-left.jpg',
							'default' => TRUE,
							'title' => 'Gap',
							'size' => [
								'width' => -1,
						...
						[
							...
							'type' => 'range_option',
							'key' => 'left_side',
							'image' => 'assets/img/clamps/90-degree.jpg',
						...
						[
							...
							'type' => 'range_option',
							'key' => 'left_side',
							'image' => 'assets/img/clamps/swivel-clamps.jpg',
						...
						[
							...
							'type' => 'range_option',
							'key' => 'left_side',
							'image' => 'assets/img/clamps/wall-clamp.jpg',
				...
				/*
				[
					'title' => 'Gap/Clamp Spacing',
					'image' => 'assets/img/center-gap.png',
					'slug' => 'left_side_spacing',
					'type' => 'range',
					'marker' => 'B',
					'label' => '',
					'unit' => 'mm',
				...
				*/
				...
				[
					...
					'notes' => [
						'image' => 'assets/img/raked-glass-left.jpg',
				...
				[
					...
					'options' => [
						[
							...
							'image' => 'assets/img/standard-hinge.jpg',
							'extra' => '',
							'key' => 'gate',
							'default' => TRUE,
							'gap' => [
						...
						[
							...
							'image' => 'assets/img/soft-hinge.jpg',
							'extra' => '',
							'key' => 'gate',
							'gap' => [
								'hinge' => 5,
				...
				[
					...
					'options' => [
						[
							'slug'  => 'left-hand',
							'title' => 'Left Hand',
							'image' => 'assets/img/left-hand.jpg',
							'extra' => '',
							'key' => 'gate',
							'default' => TRUE,
						],
						[
							'slug'  => 'right-hand',
							'title' => 'Right Hand',
							'image' => 'assets/img/right-hand.jpg',
							'extra' => '',
							'key' => 'gate',
							'default' => FALSE,
						],	
			...
			'fields' => [
				...
				[
					...
					'options' => [
						[
							'slug'  => 'opt-1',
							'image' => 'assets/img/clamps/no-clamps.png',
							'extra' => '',
							'title' => 'No Clamps',
							'key'   => 'post_options',
							'default' => TRUE,
						...
						[
							'slug'  => 'opt-2',
							'image' => 'assets/img/clamps/yes-clamps.png',
							'title' => 'Yes Clamps',
							'extra' => '',
							'key' 	=> 'post_options',
						],
				...
				[
					...
					'options' => [
						[
							'slug'  => 'opt-1',
							'title' => 'Base Plated',
							'image' => 'assets/img/spigots/base-plated.jpg',
							'extra' => '',
							'key' => 'post_options',
							'default' => TRUE,
						],
						[
							...
							'image' => 'assets/img/spigots/non-conductive.jpg',
							'extra' => '',
							'key' => 'post_options',
						],
						[
							'slug'  => 'opt-2',
							'title' => 'Core-Drilled<br>285mm',
							'image' => 'assets/img/spigots/core-drilled-285mm.jpg',
							'extra' => '',
							'key' => 'post_options',
						],
						[
							...
							'image' => 'assets/img/spigots/core-drilled-360mm.jpg',
							'extra' => '',
							'key' => 'post_options',
						],
					]
			...
			'fields' => [
				[
					...
					'options' => [
						[
							...
							'type' => 'range_option',
							'key' => 'right_side',
							'image' => 'assets/img/clamps/gap-right.jpg',
							'default' => TRUE,
							'title' => 'Gap',
							'size' => [
								'width' => -1,
				...
				*/
				...
				[
					...
					'notes' => [
						'image' => 'assets/img/raked-glass-right.jpg',
						'title' => 'When To Use Step-Up Panels',
						'description' => 'Step-Up panels are used when you need to change the heights or go over an object. e,g, over a retaining wall, over a few steps... against a boundary fence etc...',
					],
				],						
