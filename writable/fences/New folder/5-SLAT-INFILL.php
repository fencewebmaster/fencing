...
$fences['slat_fence_infill']['live'] = FALSE;
...
$fences['slat_fence_infill']['image'] = 'public/assets/img/fences/webp/slat-fence-infill.webp';
	...
	'left_side' => [
		...
		'fields' => [
			[
				...
				'options' => [
					[
						...
						'type' => 'range_option',
						'key' => 'left_side',
						'image' => 'public/assets/img/webp/yes-post.webp',
						'default' => TRUE,
						'title' => '',
						'size' => [
							'width' => 0
					...
					[
						...
						'type' => 'range_option',
						'key' => 'left_side',
						'image' => 'public/assets/img/webp/no-post-1.webp',
						'title' => '',
						'size' => [
							'width' => -50
						]
					...
					[
						...
						'type' => 'range_option',
						'key' => 'left_side',
						'image' => 'public/assets/img/webp/no-post-2.webp',
						'title' => '',
						'size' => [
							'width' => -50
						]
			...
			[
				...
				'options' => [
					[
						'slug' => 'opt-1',
						'title' => '',
						'image' => 'public/assets/img/webp/base-plate-posts.webp',
						'extra' => '',
						'key' => 'post_options'
					],
					[
						'slug' => 'opt-2',
						'title' => '',
						'image' => 'public/assets/img/webp/cement-in-posts.webp',
						'extra' => '',
						'key' => 'post_options',
						'default' => TRUE
					]
			...
			[
				...
				'notes' => [
					'image' => 'public/assets/img/webp/poolsafe-step-up-panel-v3.webp',
			...
			[
				...
				'options' => [
					[
						'slug' => '65.3',
						'title' => '65mm',
						'image' => 'public/assets/img/65mm-slats.webp',
						'extra' => '',
						'key' => 'panel_options',
						'default' => TRUE
					],
					[
						'slug' => '90.3',
						'title' => '90mm',
						'image' => 'public/assets/img/90mm-slats.webp',
						'extra' => '',
						'key' => 'panel_options'
					]
				]
			...
			[
				...
				'options' => [
					...
					[
						'slug' => 'opt-3',
						'title' => 'Wall Fix',
						'image' => 'public/assets/img/wall-fix.png',
						'extra' => '',
						'default' => TRUE
					],
					[
						'slug' => 'opt-4',
						'title' => 'Core Drilled',
						'image' => 'public/assets/img/core-drilled.png',
						'extra' => '',
						'default' => FALSE
					],
					[
						...
						'image' => 'public/assets/img/135deg-angle.png',
						'extra' => '',
						'default' => FALSE
					]
				]
