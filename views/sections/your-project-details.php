								...
								<tr>
									...
									?>
											...
											<div class="fc-project-plan-color__slide">
												<div class="fc-color-options" data-slug="<?php echo htmlspecialchars( $_fence_slug, ENT_QUOTES, 'UTF-8' ); ?>">
						...
						<tr>
							...
							<td>
								...
								<ul class="fc-project-details-value-list mb-0 ps-3">
									...
									<li><?php echo htmlspecialchars( (string) $ft_row['name'], ENT_QUOTES, 'UTF-8' ); ?> <b>x <?php echo (int) $ft_row['count']; ?></b></li>
									<?php endforeach; ?>
								</ul>
								<?php else : ?>
