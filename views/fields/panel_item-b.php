...
<div data-cart-key="panel_options" data-cart-value="{{panel_value}}" id="panel-item-{{panel_number}}" data-id="{{panel_number}}" class="fencing-panel-item long-panel-item fencing-btn-modal panel-item ally" data-key="panel_options" data-target="#fc-control-modal">
