...
function reload_fence_items() {
    ...
    for (let i = 0; i < items; i++) {
      ...
      $('#fc-fence-list').append(`<div style="margin:90px 0 40px;font-weight:bold;">SECTION ${i+1}<a href="${base_url}?section=${i+1}" data-action="edit" class="btn-fc btn-fc-sm btn-fc-outline-light fc-text-uppercase btn-fc-orange fc-w-700 fc-float-r" style=" margin-left: 16px;">
